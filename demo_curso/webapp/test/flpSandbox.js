		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#demonamedemocurso-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demonamedemocurso-display": {
								"semanticObject": "demonamedemocurso",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demoname.democurso",
									"url": sap.ui.require.toUrl("demoname/democurso")
								}
							}
						}
					}
