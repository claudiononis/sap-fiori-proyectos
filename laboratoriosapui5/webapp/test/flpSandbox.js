		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Laboratorio Sap UI5",
									"targetURL": "#sapui5laboratoriosapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5laboratoriosapui5-display": {
								"semanticObject": "sapui5laboratoriosapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5.laboratoriosapui5",
									"url": sap.ui.require.toUrl("sapui5/laboratoriosapui5")
								}
							}
						}
					}
