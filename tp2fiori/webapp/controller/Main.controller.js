sap.ui.define(
    ...
    function (Controller, History, Fragment, MessageToast) {
      ...
      return Controller.extend("tp2.tp2fiori.controller.Main", {
        onInit: function () {},
        ...
        navToIntegrantes: function (evt) {
          ...
          oTblIntegrantes.bindElement(
            "laboratorio>" + evt.getSource().getBindingContextPath()
          ); 
  
          //Ejemplos de info que podemos obtener aqui
          //evt.getSource().getBindingContext("laboratorio").getObject({ expand: "IntegrantesSet"}).IntegrantesSet.length
          //evt.getSource().getBindingContext("laboratorio").getPath()
        ...
        createIntegrante: function (evt) {
          const oTblIntegrantes = this.getView().byId("tblIntegrantes");
          const oCliente = oTblIntegrantes.getBindingContext("laboratorio").getPath();
          ...
          if (!this.byId("formIntegrantes")) {
            Fragment.load({
              id: this.oView.getId(),
              name: "tp2.tp2fiori.view.IntegranteForm",
              controller: this,
        ...
        onDelIntegrante: function (oEvent) {
          ...
          const sPathInteg = oListItem.getBindingContext("laboratorio").getPath();
