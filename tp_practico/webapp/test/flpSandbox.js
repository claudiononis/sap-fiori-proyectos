		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TabajoPractico",
									"targetURL": "#claudiotppractico-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"claudiotppractico-display": {
								"semanticObject": "claudiotppractico",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=claudio.tppractico",
									"url": sap.ui.require.toUrl("claudio/tppractico")
								}
							}
						}
					}
